                ...
                <input type="hidden" name="nomeAntigo" value="<?php echo isset($pacEdit->fotoPac)?$pacEdit->fotoPac:null?>">
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="sltEstado" class="form-select" name="sltEstado">
                            ...
                            <option value="AC" <?php if($estadoSelect == "AC"){echo 'selected';} ?>>Acre</option>
                            <option value="AL" <?php if($estadoSelect == "AL"){echo 'selected';} ?>>Alagoas</option>
                            <option value="AP" <?php if($estadoSelect == "AP"){echo 'selected';} ?>>Amapá</option>
                            <option value="AM" <?php if($estadoSelect == "AM"){echo 'selected';} ?>>Amazonas</option>
                            <option value="BA" <?php if($estadoSelect == "BA"){echo 'selected';} ?>>Bahia</option>
                            <option value="CE" <?php if($estadoSelect == "CE"){echo 'selected';} ?>>Ceará</option>
                            <option value="DF" <?php if($estadoSelect == "DF"){echo 'selected';} ?>>Distrito Federal</option>
                            <option value="ES" <?php if($estadoSelect == "ES"){echo 'selected';} ?>>Espírito Santo</option>
                            <option value="GO" <?php if($estadoSelect == "GO"){echo 'selected';} ?>>Goiás</option>
                            <option value="MA" <?php if($estadoSelect == "MA"){echo 'selected';} ?>>Maranhão</option>
                            <option value="MT" <?php if($estadoSelect == "MT"){echo 'selected';} ?>>Mato Grosso</option>
                            <option value="MS" <?php if($estadoSelect == "MS"){echo 'selected';} ?>>Mato Grosso do Sul</option>
                            <option value="MG" <?php if($estadoSelect == "MG"){echo 'selected';} ?>>Minas Gerais</option>
                            <option value="PA" <?php if($estadoSelect == "PA"){echo 'selected';} ?>>Pará</option>
                            <option value="PB" <?php if($estadoSelect == "PB"){echo 'selected';} ?>>Paraíba</option>
                            <option value="PR" <?php if($estadoSelect == "PR"){echo 'selected';} ?>>Paraná</option>
                            <option value="PE" <?php if($estadoSelect == "PE"){echo 'selected';} ?>>Pernambuco</option>
                            <option value="PI" <?php if($estadoSelect == "PI"){echo 'selected';} ?>>Piauí</option>
                            <option value="RJ" <?php if($estadoSelect == "RJ"){echo 'selected';} ?>>Rio de Janeiro</option>
                            <option value="RN" <?php if($estadoSelect == "RN"){echo 'selected';} ?>>Rio Grande do Norte</option>
                            <option value="RS" <?php if($estadoSelect == "RS"){echo 'selected';} ?>>Rio Grande do Sul</option>
                            <option value="RO" <?php if($estadoSelect == "RO"){echo 'selected';} ?>>Rondônia</option>
                            <option value="RR" <?php if($estadoSelect == "RR"){echo 'selected';} ?>>Roraima</option>
                            <option value="SC" <?php if($estadoSelect == "SC"){echo 'selected';} ?>>Santa Catarina</option>
                            <option value="SP" <?php if($estadoSelect == "SP"){echo 'selected';} ?>>São Paulo</option>
                            <option value="SE" <?php if($estadoSelect == "SE"){echo 'selected';} ?>>Sergipe</option>
                            <option value="TO" <?php if($estadoSelect == "TO"){echo 'selected';} ?>>Tocantins</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input class="form-control" type="file" id="filFoto" name="filFoto" value="<?php echo isset($pacEdit->fotoPac)?$pacEdit->fotoPac:null;?>">
                    </div>
                    <div class="col-12">
